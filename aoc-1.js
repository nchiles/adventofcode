...
// PART TWO
const findEntriesTwo = () => {
  input.forEach(num => {    
    for(let i=0; i<input.length; i++) {
      for(let j=0; j<input.length; j++) {
        if (num + input[i] + input[j] === 2020) {
          console.log(num, input[i], input[j]);
          console.log(num + input[i] + input[j]);
          console.log(num * input[i] * input[j]);
        }
      }
